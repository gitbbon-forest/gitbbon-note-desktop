...
export const EDITOR_GROUP_HEADER_FOREGROUND = registerColor('editorGroupHeader.foreground', editorForeground, localize('editorGroupHeaderForeground', "Foreground color of the editor group title header. Editor groups are the containers of editors."));
